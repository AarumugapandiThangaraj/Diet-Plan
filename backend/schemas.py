...
class DailyTargetsResponse(BaseModel):
    ...
    fiberGRaw: int = Field(..., description="Raw calculated fiber target.", json_schema_extra={"example": 29})
    fiberGMinimum: int = Field(..., description="Minimum recommended fiber intake (default 25g).", json_schema_extra={"example": 25})
